...
class AdminController extends Controller
{
    ...
    public function admin_dashboard(Request $request)
    {
        ...
        $stock   = 0;
        $p_stock = Product::with('stocks')->get();
        ...
        $aff = CommissionHistory::count();
        $aff_today = CommissionHistory::whereDate('created_at', \Carbon\Carbon::today())->count();
        


        return view('backend.dashboard', compact('root_categories', 'cached_graph_data','products','vendors','stock','aff','aff_today'));
    }

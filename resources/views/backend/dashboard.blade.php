    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-3 col-6">
                <a href="/admin/sellers">
                    <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden bg-color-5">
                        <div class="px-3 pt-3">
                            <div class="opacity-50">
                                <span class="fs-12 d-block">{{ __('lang.total_vendors') }}</span>
                            
                            </div>
                            <div class="h3 fw-700 mb-3">{{ $vendors }}</div>
                        </div>
            ...
            <a href="/admin/categories">
                <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden bg-color-3">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.total_categories') }}</span>
            ...
            <a href="/admin/products/all">
                <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden bg-color-4">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.total_products') }}</span>
                          
                        </div>
                        <div class="h3 fw-700 mb-3">{{ $products }}</div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="rgba(255,255,255,0.3)" fill-opacity="1" d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
                    </svg>
        ...
        <a href="/admin/all_orders">
                <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden bg-color-2">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.total_orders') }}</span>
            ...
            <a href="/admin/customers">
                <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden bg-color-1">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.total_customers') }}</span>
            ...
            <div class="col-lg-3 col-6">
            <a href="/admin/brands">
                <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden bg-color-4">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.total_brands')}}</span>
            ...
            <div class="col-lg-3 col-6">
            <a href="/admin/stock_report">
                <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden bg-color-1">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.stock')}}</span>
                           
                        </div>
                        <div class="h3 fw-700 mb-3">{{$stock }}</div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="rgba(255,255,255,0.3)" fill-opacity="1" d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
                    </svg>
            ...
            <div class="col-lg-3 col-6">
                <a href="/admin/commission-log">
                <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden bg-color-5">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.aff')}}</span>
                           
                        </div>
                        <div class="h3 fw-700 mb-3">{{$aff }}</div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="rgba(255,255,255,0.3)" fill-opacity="1" d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
                    </svg>
            ...
            <div class="col-lg-3 col-6">
            <a href="/admin/commission-log">
                <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden bg-color-2">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ __('lang.aff_today')}}</span>
                           
                        </div>
                        <div class="h3 fw-700 mb-3">{{$aff_today }}</div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="rgba(255,255,255,0.3)" fill-opacity="1" d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
                    </svg>
...
<div class="card bg-color-9">
    ...
    <div class="card-body">
        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4" data-md-items="3" data-sm-items="2" data-arrows='true'>
            @foreach (filter_products(\App\Models\Product::where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(1)->get() as $key => $product)

...
<div class="colors">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-xxl-4">
            ...
            <div class="card shadow-none mb-4 bg-primary py-4 bg-color-1">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
        ...
        <div class="col-sm-6 col-md-6 col-xxl-4">
        <a href="/seller/products">
            <div class="card shadow-none mb-4 bg-primary py-4 bg-color-2">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">اجمالي المخزون</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                {{ $total_stock}}
                            </h3>
        ...
        <a href="/seller/orders">
            <div class="card shadow-none mb-4 bg-primary py-4 bg-color-5">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">عدد القطع المباعة</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                {{ $total_qty}}
                            </h3>
        ...
        <div class="col-sm-6 col-md-6 col-xxl-4">
        <a href="/seller/orders">
            <div class="card shadow-none mb-4 bg-primary py-4 bg-color-3">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">اجمالي الطلبيات</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-light">المخزون المتبقي</span>
                                </p>
                                <h3 class="mb-0 text-white fs-30">
                                    {{ $stock}}
                                </h3>
        ...
        <a href="/seller/money-withdraw-requests">
            <div class="card shadow-none mb-4 bg-primary py-4 bg-color-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">اجمالي المبيعات</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                @php
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-light">الطلبات الجديدة</span>
                                </p>
                                <h3 class="mb-0 text-white fs-30">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-light">الطلبات الملغية</span>
                                </p>
                                <h3 class="mb-0 text-white fs-30">
        ...
        <div class="col-sm-6 col-md-6 col-xxl-4">
            <a href="/seller/orders?delivery_status=on_the_way">
                <div class="card shadow-none mb-4 bg-primary py-4 bg-color-3">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-light">الطلبات قيد التوصيل</span>
                                </p>
                                <h3 class="mb-0 text-white fs-30">
        ...
        <div class="col-sm-6 col-md-6 col-xxl-4">
            <a href="/seller/orders?delivery_status=delivered">
                <div class="card shadow-none mb-4 bg-primary py-4 bg-color-4">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-light">الطلبات المكتملة</span>
                                </p>
                                <h3 class="mb-0 text-white fs-30">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none h-450px mb-0 h-100 bg-color-6">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4" style="display:none">
        <a href="/seller/orders">
            <div class="card h-450px mb-0 h-100 bg-color-7">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        الطلبات
                        <p class="small text-muted mb-0">
                            <span class="fs-12 fw-600">الشهر الحالي</span>
                        </p>
                    </div>
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23742" data-name="Group 23742" transform="translate(2044 3467)">
                                    ...
                                    <g id="Group_23741" data-name="Group 23741" transform="translate(310 759)">
                                        <path id="Path_26908" data-name="Path 26908"
                                            ...
                                            transform="translate(-2351 -4226)" fill="#FFFFFF" />
                                        <path id="Path_26909" data-name="Path 26909"
                                            ...
                                            transform="translate(-2491.298 -4498.774)" fill="#FFFFFF" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">جديدة</span>
                            </p>
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23751" data-name="Group 23751" transform="translate(0 0.001)">
                                    <g id="Group_23750" data-name="Group 23750" transform="translate(0 -0.001)"
                                        ...
                                        <path id="Path_27506" data-name="Path 27506"
                                            ...
                                            transform="translate(-174.22 -84.719)" fill="#FFFFFF" />
                                        <path id="Path_27507" data-name="Path 27507"
                                            ...
                                            transform="translate(-227.869 -227.867)" fill="#FFFFFF" />
                                        <path id="Path_27508" data-name="Path 27508"
                                            ...
                                            transform="translate(-307.867 -307.756)" fill="#FFFFFF" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">ملغية</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'cancelled')->count() }}
                            </h3>
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23745" data-name="Group 23745" transform="translate(1901 3455)">
                                    ...
                                    <g id="Group_23744" data-name="Group 23744" transform="translate(-867.487 654.098)">
                                        ...
                                        <path id="Path_26914" data-name="Path 26914"
                                            ...
                                            transform="translate(-2536.278 -4319.726)" fill="#FFFFFF" />
                                        <path id="Path_26915" data-name="Path 26915"
                                            ...
                                            transform="translate(-2493.036 -4255.966)" fill="#FFFFFF" />
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">قيد التوصيل</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'on_the_way')->count() }}
                            </h3>
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23747" data-name="Group 23747" transform="translate(1894 3457)">
                                    ...
                                    <g id="Group_23746" data-name="Group 23746" transform="translate(-1599.983 686.845)">
                                        ...
                                        <path id="Path_26919" data-name="Path 26919"
                                            ...
                                            transform="translate(-2557.593 -4432.681)" fill="#FFFFFF" />
                                        <path id="Path_26920" data-name="Path 26920"
                                            ...
                                            transform="translate(-2626.31 -4518.65)" fill="#FFFFFF" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">تم التوصيل</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count() }}
                            </h3>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            ...
            @endif
            <div
                class="card bg-color-9 mb-0 @if (addon_is_activated('seller_subscription')) px-4 py-5 @else p-5 h-100 @endif d-flex align-items-center justify-content-center">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="{{ route('seller.money_withdraw_requests.index') }}"
                class="card bg-color-10 mb-4 p-4 text-center bg-soft-primary h-180px">
                ...
                <div class="m-3">
                    <svg id="Group_22725" data-name="Group 22725" xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                        ...
                        <path id="Path_110"
                            ...
                            fill="#FFFFFF" />
                        <path id="Path_111" d="M28.5,21h-9a4.5,4.5,0,0,0,9,0" fill="#FFFFFF" />
                    </svg>
                </div>
            </a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="{{ route('seller.products') }}" class="card bg-color-11 mb-4 p-4 text-center h-180px">
                <div class="fs-16 fw-600 text-primary">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <g id="Group_22724" data-name="Group 22724" transform="translate(-1284 -875)">
                            <rect id="Rectangle_17080" data-name="Rectangle 17080" width="2" height="48" rx="1"
                                transform="translate(1307 875)" fill="#FFFFFF" />
                            <rect id="Rectangle_17081" data-name="Rectangle 17081" width="2" height="48" rx="1"
                                transform="translate(1332 898) rotate(90)" fill="#FFFFFF" />
                        </g>
                    </svg>
                </div>
            </a>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary bg-color-12">
                <div class="fs-16 fw-600 text-primary">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary bg-color-13">
                <div class="fs-16 fw-600 text-primary">
                ...
                <div class=" m-3">
                    <svg id="Group_30" data-name="Group 30" xmlns="http://www.w3.org/2000/svg" width="31.999" height="32"
                        ...
                        <path id="Path_83" data-name="Path 83"
                            ...
                            transform="translate(-92.946 -10)" fill="#FFFFFF" />
